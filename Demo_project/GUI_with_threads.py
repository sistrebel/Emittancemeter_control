# -*- coding: utf-8 -*-
"""
Created on Thu Oct 19 16:42:00 2023
...
import New_communications_threads as control
...
class MainWindow(QMainWindow): 
    ...
    def goto_position(self,Target):
        ...
        self.server.issue_motor_command(self.movingmotor_queue,("release_brake",))
        time.sleep(0.1)
        self.server.issue_motor_command(self.movingmotor_queue, ("go_to_position",position))
