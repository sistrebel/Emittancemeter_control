...
class MainWindow(QMainWindow): 
    ...
    def start_scan_thread(self):
        ...
        resolution_x = self.mm_to_steps(float(self.textEdit_Resolution_x.toPlainText())) #retrieve resolution in mm
        resolution_y = self.mm_to_steps(float(self.textEdit_Resolution_y.toPlainText()))
        resolution_z = self.mm_to_steps(float(self.textEdit_Resolution_z.toPlainText()))
